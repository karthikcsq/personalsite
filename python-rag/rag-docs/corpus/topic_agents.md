---
applies_to: [topic:agents]
topics: [agents, mcp, multi-agent, automation, product, design]
---

## When an agent is worth building

Agents are genuinely useful when they actually save you time or money. I absolutely do not mean save you effort. There are so many agents in the world that save people effort, which is useless, because it doesn't improve output. In fact, by removing effort and not saving time, all you're doing is making the person worse at that task.

## Where most agents fail

Customer support chatbots are a clear example. Research assistant agents that just summarize also don't save time, because when it's time to actually cite or build off of another paper, you have to fully go through and understand it anyway, whether it's through AI-assisted guided learning or just reading the paper.
